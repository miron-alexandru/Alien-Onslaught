...
class AlienMovementTestCase(unittest.TestCase):
    ...
    def test_update_horizontal_position_direction_change(self, mock_random, mock_time):
        ...
        self.assertEqual(self.alien_movement.last_direction_change, mock_time.return_value)
        self.assertEqual(self.alien_movement.direction_change_delay, mock_random.return_value)
