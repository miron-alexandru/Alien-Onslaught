...
from managers.alien_bullets_manager import AlienBulletsManager
from managers.aliens_manager import AliensManager
...
from managers.screen_manager import ScreenManager, LoadingScreen
from managers.buttons_manager import GameButtonsManager
...
class AlienOnslaught:
    ...
    def initialize_managers(self):
        ...
        self.screen_manager = ScreenManager(
            self, self.settings, self.score_board, self.buttons_manager, self.screen
        )
    ...
    def handle_single_player_button_click(self):
    ...
    def handle_multiplayer_button_click(self):
    ...
    def _play_game_over_sound(self):
        if not self.ui_options.game_over_sound_played:
            play_music(self.sound_manager.menu_music, "game_over")
            self.ui_options.game_over_sound_played = True
            self.sound_manager.current_sound = self.sound_manager.menu_music["game_over"]
