"""
The 'aliens_manager' module contains classes for managing aliens and bosses in the game.

Classes:
    - 'AliensManager': A class that manages the creation, update of aliens and bosses.
"""
